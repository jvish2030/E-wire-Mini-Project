        ...
        <div class="container py-lg-5">
            <div class="welcome-grids row">
                <div class="col-lg-6 mb-lg-0 mb-5">
                    <h3 class="hny-title">
                        About Our E<span>WIRE</span></h3>
                    <p class="my-4">Hari Om Electricals & Appliances in Nagpur is one of the leading businesses in Nagpur. Also known for Cable Deals, Cable Wire Deals, Cable Deals-Polycab, Winding Wire Deals and much more.</p>
                    <p class="mb-4">Established in the year 2007,believes that customer satisfaction is as important as their products and services, have helped this establishment garner a vast base of customers</p>
                    <div class="read">
                        <a href="#" class="read-more btn">Shop Now</a>
                    </div>	
                </div>
                <div class="col-lg-6 welcome-image">
                    <img src="assets/images/offer.png" class="img-fluid" alt="" />
                </div>	
        ...
        <div class="container py-lg-5">
            <div class="row story-6-grids text-left">
                ...
                <div class="col-lg-7 story-gd pl-lg-4">
                    ...
                    <p>Hari Om Electricals & Appliances in Golibar Chowk has a wide range of products and / or services to cater to the varied requirements of their customers. The staff at this establishment are courteous and prompt at providing any assistance. They readily answer any queries or questions that you may have. </p>
                    ...
                    <div class="row story-info-content mt-md-5 mt-4">
                        ...
                        <div class="col-md-6 story-info">
                            ...
                            <p>Shop No, Electric Market, Galli No-B5, Golibar Chowk, Nagpur - 440018 </p>


                        </div>
                        <div class="col-md-6 story-info">
                            <h5> <a href="#">02. Add To Cart</a></h5>	
                            <p>It is informs you about the selected product, and offers related to it</p>
                        </div>
                        <div class="col-md-6 story-info">
                            <h5> <a href="#">03. Gift Cards</a></h5>	
                            <p>Gift cards offer seamless convenience to givers. Applicable to only few.</p>
                        </div>
                        <div class="col-md-6 story-info">
                            <h5> <a href="#">04. Payment Modes</a></h5>	
                            <p>Safe and secured with different modes available</p>
                        </div>
                    </div>
